<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index_Admin.aspx.cs" Inherits="GYECWeb.page_admin.Index_Admin" %>
...
<head>
    ...
    <!--[if lt IE 9]>
<script type="text/javascript" src="../Scripts/js_admin/html5.js"></script>
<script type="text/javascript" src="../Scripts/js_admin/respond.min.js"></script>
<script type="text/javascript" src="../Scripts/js_admin/PIE_IE678.js"></script>
<![endif]-->
    <link href="../css/css_admin/H-ui.css" rel="stylesheet" type="text/css" />
    <link href="../css/css_admin/H-ui.admin.css" rel="stylesheet" type="text/css" />
    <link type="text/css" rel="stylesheet" href="../font/font-awesome.min.css" />
    <!--[if IE 7]>
<link href="../font/font-awesome-ie7.min.css" rel="stylesheet" type="text/css" />
<![endif]-->
    <!--[if IE 6]>
<script type="text/javascript" src="../Scripts/js_admin/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<body style="overflow: hidden">
    ...
    <a class="Hui-logo l" title="H-ui.admin v2.1" href="/">H-ui.admin</a> 
    ...
    <a class="btn btn-danger radius ml-10" href="#" title="退出"><i class="icon-off"></i> 退出</a>
    </span> 
    ...
    <div class="menu_dropdown bk_2">
      <dl id="menu-user">
        ...
        <dd>
          <ul>
            <li><a _href="User_List_Admin.ashx" href="javascript:;">用户管理</a></li>
    ...
    <div id="iframe_box" class="Hui-articlebox">
      <div class="show_iframe">
        ...
        <iframe scrolling="yes" frameborder="0" src="Welcome_Admin.ashx"></iframe>
      </div>
    </div>
  </section>
    </div>
    <script src="../Scripts/jquery-2.1.4.min.js" type="text/javascript"></script>
    <script src="../Scripts/js_admin/Validform_v5.3.2_min.js" type="text/javascript"></script>
    <script src="../layer/layer.min.js" type="text/javascript"></script>
    <script src="../Scripts/js_admin/H-ui.admin.js" type="text/javascript"></script>
    <script src="../Scripts/js_admin/H-ui.js" type="text/javascript"></script>
</body>
</html>
